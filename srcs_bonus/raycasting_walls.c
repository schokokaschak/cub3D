...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/21 13:15:57 by akashets          #+#    #+#             */
/*   Updated: 2023/04/25 10:57:30 by nradin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	calc_side_dist_y(t_game *game)
{
	t_raycast	*rays;
...
void	calc_hit(t_game *game)
{
	...
	while (rays->hit == 0)
	{
		...
		if (game->imap[rays->map_y][rays->map_x] > 0)
			rays->hit = 1;
	}
	check_side(game);
}
